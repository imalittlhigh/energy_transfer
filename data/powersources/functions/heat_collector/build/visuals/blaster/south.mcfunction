...
summon block_display ~-0.5 ~-0.5 ~-0.5 {Tags:["powersources.blockdisplay.heat_collector.blaster","powersources.blockdisplay.heat_collector","powersources.blockdisplay"],Passengers:[{id:"minecraft:block_display",Tags:["powersources.blockdisplay.heat_collector.blaster","powersources.blockdisplay.heat_collector","powersources.blockdisplay"],block_state:{Name:"minecraft:blast_furnace",Properties:{facing:"east",lit:"false"}},transformation:[0.0000f,0.0000f,-0.8750f,0.9375f,0.0000f,0.8750f,0.0000f,0.1250f,0.8750f,0.0000f,0.0000f,0.0625f,0.0000f,0.0000f,0.0000f,1.0000f]}]}
